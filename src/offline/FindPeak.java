...
public class FindPeak {
	...
	private static final String URL_PREFIX = "/FunEvents";
	...
	public static void main(String[] args) {
		...
		// emit(this.time.substring(0, 5), 1);   //subtring用来把秒忽略掉
		// }
		// }
		...
		results.forEach(new Block<Document>() {  //block是匿名class
			@Override
	...
	private static List<LocalTime> initBuckets() {
		...
		for (int i = 0; i < 96; ++i) { // 一天24小时 * 4 = 96 个 15分钟
			buckets.add(time);
			time = time.plusMinutes(15);
		}
		// 区间：00:00 - 00: 14, 00:15 - 00:19 ....
		return buckets;
	}
