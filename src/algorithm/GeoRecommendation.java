...
public class GeoRecommendation {
	...
	public List<Item> recommendItems(String userId, double lat, double lon) {
		...
		Set<Item> recommendedItems = new HashSet<>(); // step 3  去重，确保同一个event 不会被推荐两次
		...
		List<Item> filteredItems = new ArrayList<>(); // step 4  已经收藏过，就不再推荐,filter一下
		...
		// step 5. perform ranking of these items based on distance.离得越近排的越靠前
